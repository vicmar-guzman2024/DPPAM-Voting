    ...
    <div class="wrapper">
        ...
        <div class="main">
            ...
            <main class="container p-5">
                ...
                <form action="addnewvolunteers.php" method="POST" class="row mt-5" enctype="multipart/form-data">
                        ...
                        <div class="d-flex flex-column flex-md-row justify-content-start align-items-center gap-3 gap-md-5 mb-5">
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" aria-label="Middle name" class="form-control" placeholder="Middle name" name="mname" id="middlename">
                                    ...
                                    <div class="col-md-6 mb-4">
                                        ...
                                        <input type="date" class="form-control" id="dateExp" name="prev_ppcrv_exp_date">
                                    </div>
                                    ...
                                    <div class="col-md-9 mb-4">
                                        ...
                                        while ($row = $sql_result5->fetch_assoc()) {
                                            ...
                                            $options .= "<option value=\"$MISSION_NAME\">$MISSION_NAME $MISSION_DESCRIPTION</option>";
                                        } ?>
                                        ...
                                        <div id="selected-prevExpAss" class="mt-3">
                                            ...
                                            <div class="d-flex flex-column flex-md-row gap-3 align-items-center">
                                                ...
                                                <input class="form-check-input" type="radio" name="voter_status" id="yes" value="Yes">
                                                <label class="form-check-label" for="yes">Yes</label>
                                                </div>
                                                <div class="form-check">
                                                <input class="form-check-input" type="radio" name="voter_status" id="no" value="No">
                                            ...
                                            <div class="row g-3 mt-3">
                                                ...
                                                <input type="text" class="form-control" id="precinctNo" name="precinct_no" placeholder="Precinct No.">
                                                </div>
                                                <!-- Polling Place (Yes) -->
                                                <div class="col-md-6 d-flex align-items-center gap-2">
                                                <label for="pollingPlace" class="form-label text-nowrap mb-0">Polling Place</label>
                                                <input type="text" class="form-control" id="pollingPlace" name="polling_place" placeholder="Polling Place">
                                                </div>
                                                <!-- Reason (No) -->
                                                <div class="col-md-6 d-flex align-items-center gap-2">
                                        ...
                                        <select id="prefVolAss" name="pref_ppcrv_vol_ass" class="form-select" required>
                                        <?php
                                        while ($row = $sql_result5->fetch_assoc()) {
                                            $MISSION_NAME = $row['MISSION_NAME'];
                                            $MISSION_DESCRIPTION = $row['MISSION_DESCRIPTION'];
