...
<head>
    ...
    <title>Coordinator - Sign Up</title>
</head>
...
<body>
    ...
    <section class="signInContainer p-5" style="height: 100%;">
        ...
        <form action="php/sign_up_process.php" method="POST"
            class="container mt-3 py-5 px-4 shadow-lg rounded"
            ...
            <div class="mb-3">
                ...
                value="<?php echo isset($_SESSION['temp_firstname']) ? $_SESSION['temp_firstname'] : ''; ?>" required>
            </div>

            <!-- Last Name Input -->
            <div class="mb-3">
                <input type="text" class="form-control" name="lastname" id="lastname" placeholder="Lastname"
                value="<?php echo isset($_SESSION['temp_lastname']) ? $_SESSION['temp_lastname'] : ''; ?>" required>
            </div>
            ...
            <div class="mb-3">
                <input type="tel" class="form-control" name="phone_num" id="phone" placeholder="Phone: (XXXX-XXX-YYYY)"
                    ...
                    value="<?php echo isset($_SESSION['temp_phone_num']) ? $_SESSION['temp_phone_num'] : ''; ?>"
